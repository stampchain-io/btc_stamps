...
CREATE TABLE IF NOT EXISTS `StampTableV4` (
  ...
  INDEX `idx_creator_tx_index` (`creator`, `tx_index`),
  INDEX `idx_stamp_url_mimetype` (`stamp_url`(100), `stamp_mimetype`(50)),
  INDEX `idx_stamp_file` (`stamp_hash`, `stamp_mimetype`, `stamp_url`(100)),
  INDEX `idx_cpid_ident` (`cpid`, `ident`),
  INDEX `idx_stamp_count` (`is_btc_stamp`, `ident`, `creator`),
