...
import config
from index_core.fetch_utils import get_xcp_assets_by_cpids, RateLimiter
...
def update_market_data_async(db):
    ...
    def start_background_jobs(self):
        ...
        logger.info(f"📊 Job Schedule: Stamps={self.stamp_interval}min, SRC-20={self.src20_interval}min, Collections={self.collection_interval}min")
        logger.info(f"⚡ Rate Limits: Counterparty={self.counterparty_rate_limit}/sec, Exchange={self.exchange_rate_limit}/sec")
    ...
    def _schedule_stamp_jobs(self):
        ...
        while self.running:
            try:
                ...
                logger.info(f"📊 Stamp Update Cycle Complete:")
    ...
    def _schedule_src20_jobs(self):
        ...
        while self.running:
            try:
                ...
                logger.info(f"🪙 SRC-20 Update Cycle Complete:")
