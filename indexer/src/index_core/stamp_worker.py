...
class StampWorker:
    ...
    def process_stamp_market_data(self, cpid: str) -> Optional[Dict]:
        ...
        try:
            ...
            market_data = self._calculate_market_metrics(
                cpid, dispensers_data, dispenses_data, balances_data
            )
    ...
    def _fetch_dispensers(self, cpid: str) -> Optional[List[Dict]]:
        ...
        try:
            ...
            params = {
                "limit": MAX_DISPENSERS_PER_REQUEST,
    ...
    def _fetch_dispenses(self, cpid: str) -> Optional[List[Dict]]:
        ...
        try:
            ...
            params = {
                "limit": MAX_DISPENSES_PER_REQUEST,
                "show_unconfirmed": "false"
            }
    ...
    def _fetch_balances(self, cpid: str) -> Optional[List[Dict]]:
        ...
        try:
            ...
            params = {
                "limit": MAX_BALANCES_PER_REQUEST,
                "show_unconfirmed": "false"
            }
    ...
    def _calculate_market_metrics(
        self, 
        cpid: str, 
        dispensers: Optional[List[Dict]], 
        dispenses: Optional[List[Dict]], 
    ...
    def _calculate_holder_metrics(self, balances: List[Dict]) -> Dict:
        ...
        try:
            ...
            if quantities:
                ...
                holder_metrics['avg_holding'] = total_supply / len(quantities)
                
                                                  # Calculate median
                 sorted_quantities = sorted(quantities)
                 n = len(sorted_quantities)
                 if n % 2 == 0:
                     holder_metrics['median_holding'] = (sorted_quantities[n // 2 - 1] + sorted_quantities[n // 2]) / 2
                 else:
                     holder_metrics['median_holding'] = sorted_quantities[n // 2]
