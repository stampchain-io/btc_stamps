...
CP_RPC_URL = os.environ.get(
    "CP_RPC_URL", "https://public.coindaddy.io:4001/api/rest/"
...
CP_STAMP_GENESIS_BLOCK = (
    779652  # block height of first valid stamp transaction on counterparty
)
...
CP_SRC20_END_BLOCK = (
    796000  # The last SRC-20 on CP  - IGNORE ALL SRC-20 on CP AFTER THIS BLOCK
)
...
BLOCK_FIRST_MAINNET = (
    CP_STAMP_GENESIS_BLOCK  # 791243 # 791510  # 791243  # 796000  # 790249  # 779650
)
