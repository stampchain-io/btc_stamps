...
class TestSRC721R0DeploySafety(unittest.TestCase):
    ...
    def test_regular_stamp_with_r0_not_affected(self):
        ...
        stamp_data_json = {
            "op": "deploy",
            "v": "r0",
            "name": "Should not be a collection",
            "data": "Some stamp data"
        }
    ...
    def test_html_p2wsh_not_affected(self):
        """Test that HTML P2WSH content is not affected"""
        html_content = b"""<html>
    ...
    def test_nested_json_not_affected(self):
        ...
        nested_data = {
            "p": "SRC-721",
            "op": "deploy",
            "v": {  # v is an object instead of string
                "version": "r0",
                "sub": "data"
            },
