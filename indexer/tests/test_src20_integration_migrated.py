...
class TestSRC20IntegrationRealData:
    ...
    def setup_integration_environment(self, mock_db_manager):
        ...
        cursor.fetchone.return_value = None  # Default to no deployment
    ...
    def create_stamp_data_from_real_tx(self, tx_data: dict, metadata: dict) -> StampData:
    ...
    def create_stamp_data_with_custom_data(self, tx_hash: str, data_content, block_index: int = 800000) -> StampData:
    ...
    def test_valid_transactions_pipeline(self, setup_integration_environment, valid_transactions):
        ...
        for i, tx_data in enumerate(valid_transactions):
            ...
            stamp_data = self.create_stamp_data_from_real_tx(tx_data, metadata)
...
class TestSRC20EdgeCasesRealData:
    ...
    def _test_synthetic_over_mint_scenarios(self, db_simulator):
        ...
        for test_case in over_mint_test_cases:
            ...
            deploy_stamp_data = self.create_stamp_data_with_custom_data(
                f"deploy_{test_case['name']}_hash", json.dumps(deploy_data)
            )
            ...
            mint_stamp_data = self.create_stamp_data_with_custom_data(f"mint_{test_case['name']}_hash", json.dumps(mint_data))
    ...
    def _test_synthetic_unicode(self, db_simulator):
        ...
        for unicode_tick, description in unicode_test_cases:
            ...
            stamp_data = self.create_stamp_data_with_custom_data(
    ...
    def test_string_bytestring_conversion(self, setup_integration_environment):
        ...
        for variant_name, data_variant in test_variants:
            ...
            stamp_data = self.create_stamp_data_with_custom_data(f"{variant_name}_test_hash", data_variant)
    ...
    def test_zlib_compression_handling(self, setup_integration_environment):
        ...
        stamp_data = self.create_stamp_data_with_custom_data("compressed_test_hash", compressed_data)
