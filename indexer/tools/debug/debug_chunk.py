                ...
                try:
                    ...
                    if RUST_PARSER_AVAILABLE:
                        ...
                        try:
                            ...
                            logger.info(f"  Rust should_include: {tx_info.should_include}")
                            logger.info(f"  Rust has_valid_pattern: {tx_info.has_valid_pattern}")
                            logger.info(f"  Rust has_valid_data: {tx_info.has_valid_data}")
                            logger.info(f"  Rust keyburn: {tx_info.keyburn}")
