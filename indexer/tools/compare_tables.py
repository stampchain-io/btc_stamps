...
print(f"not in SRC20Valid {prod_host} ", len(not_in_prod_list_src20), (not_in_prod_list_src20))
print(f"not in SRC20Valid {dev_host} ", len(not_in_prod_list_src20), (not_in_dev_list_src20))
